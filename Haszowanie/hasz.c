...
void putToArray(long int hasz,int j,int lines){
  int counter = 0,i=1;
  while (T[hasz].liczba!=0 && counter<lines) {
    hasz=(hasz+i*i)%lines;
    counter++;
    i++;
  }
...
masz ?
^Cdcwik@sigma-ng aisd_zad5b
$ clear
[3;J
dcwik@sigma-ng aisd_zad5b
$ cat hasz.c 
/*
Dawid Ćwik 238137
AlgorytmyiStruktury Haszowanie 10.3 - kwadrat
*/
